# 🔋 Sistema de Rastreamento Baterias Moura - Blockchain Edition

## Descrição
Sistema completo de gestão e rastreamento de baterias Moura desenvolvido em blockchain. Permite o cadastro, edição, remoção e monitoramento completo do ciclo de vida das baterias com total transparência e segurança através da tecnologia blockchain.

## 🎯 Características do Sistema
- **Gestão Completa de Baterias**: CRUD completo (Create, Read, Update, Delete)
- **Interface Moderna**: Design premium com identidade visual Moura
- **Blockchain Arbitrum Sepolia**: Baixo custo e alta performance
- **Segurança Avançada**: Apenas o proprietário pode gerenciar o sistema
- **Rastreabilidade Completa**: Histórico imutável de todas as operações
- **Design Responsivo**: Funciona perfeitamente em desktop e mobile
- **Efeitos Visuais**: Animações modernas e experiência de usuário premium
...
### Nova Identidade Visual Moura
- **Cores Premium**: Sistema de cores CSS Variables com paleta Moura
  - `--moura-red: #DC143C` - Vermelho característico da Moura
  - `--moura-dark-red: #B91C3C` - Versão mais escura
  - `--moura-orange: #FF6B35` - Laranja energético
  - `--moura-yellow: #FFB000` - Amarelo vibrante
- **Gradientes Dinâmicos**: Fundos com gradientes animados
- **Glassmorphism**: Efeitos de vidro com backdrop-filter
- **Tipografia Moderna**: Inter font para melhor legibilidade

### Características do Design Avançado
- **Responsivo Premium**: Design que se adapta perfeitamente a qualquer dispositivo
- **Animações Suaves**: Transições CSS3 com cubic-bezier para experiência fluida
- **Cards Interativos**: Efeitos hover 3D com transformações e sombras dinâmicas
- **Modal Moderno**: Interface overlay com blur de fundo
- **Feedback Visual Rico**: Loading spinners, badges de status e alertas contextuais
- **Microinterações**: Efeitos de hover, focus e animações de entrada

### Efeitos Especiais
- **Glow Effect**: Brilho característico da marca Moura
- **Particle Animation**: Partículas flutuantes no background
- **Gradient Shift**: Gradientes que mudam de cor suavemente
- **Typing Effect**: Efeito de digitação para títulos
- **Pulse Animations**: Indicadores de conexão blockchain pulsantes
- **Counter Animations**: Contadores animados para estatísticas
